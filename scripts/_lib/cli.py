"""scripts/_lib/cli.py — shared scaffolding for the `darkmind-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("darkmind-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/darkmind-foo`
...
VERSION = "0.1.0"  # bumped centrally; every darkmind-* CLI reports this
