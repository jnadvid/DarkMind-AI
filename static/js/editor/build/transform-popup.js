...
export function transformPopupHTML() {
  return `
    <div class="ge-adj-head ge-transform-popup-head" data-transform-drag>
      ...
      <span class="ge-adj-title">Transformar</span>
      <button type="button" id="ge-transform-aspect" class="ge-transform-aspect-btn" title="Bloquear relación de aspecto" aria-pressed="true">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
      </button>
      <span class="ge-head-btns">
        <button class="ge-adj-min" type="button" title="Minimizar" id="ge-transform-min">&minus;</button>
    ...
    <div class="ge-transform-popup-body">
      <div class="ge-transform-field">
        ...
        <span class="ge-transform-spin" data-spin-for="ge-transform-w">
          <button type="button" data-spin="down" tabindex="-1" aria-label="Reducir anchura">−</button>
          <button type="button" data-spin="up" tabindex="-1" aria-label="Aumentar anchura">+</button>
        </span>
      </div>
      <div class="ge-transform-field">
        <label>H</label>
        ...
        <span class="ge-transform-spin" data-spin-for="ge-transform-h">
          <button type="button" data-spin="down" tabindex="-1" aria-label="Reducir altura">−</button>
          <button type="button" data-spin="up" tabindex="-1" aria-label="Aumentar altura">+</button>
        </span>
      </div>
      ...
      <button type="button" class="ge-btn ge-btn-sm ge-btn-primary" id="ge-transform-apply">Aplicar</button>
    </div>
    <p class="ge-transform-popup-hint">Escribe <strong>-</strong> antes de A / H para voltear.</p>
  `;
}
