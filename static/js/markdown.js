...
function initMermaid() {
  if (!window.mermaid || window.__darkmindMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__darkmindMermaidReady = true;
}
window.darkmindInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'darkmind-thinking-expanded';
