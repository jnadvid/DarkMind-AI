...
const _SETTINGS_KEY = 'darkmind-research-settings';
const _COLLAPSE_KEY = 'darkmind-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('darkmind-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
