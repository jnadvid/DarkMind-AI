...
function _initHoverCardSpaceToggle() {
  if (document._darkmindHoverCardSpaceToggle) return;
  document._darkmindHoverCardSpaceToggle = true;
 ...
 */
export function styledConfirm(message, { confirmText = 'Confirmar', cancelText = 'Cancelar', danger = false } = {}) {
