...
INTERNAL_TOOL_TOKEN = os.environ.get("DARKMIND_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-DarkMind-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-DarkMind-Internal-Token), or
