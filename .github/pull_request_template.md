...
- [ ] I searched [open issues](https://github.com/pewdiepie-archdaemon/darkmind/issues) and [open PRs](https://github.com/pewdiepie-archdaemon/darkmind/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses DarkMind's existing visual language. Specifically:
