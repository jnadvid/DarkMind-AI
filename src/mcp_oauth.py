...
Registration, authorization-code + PKCE, token refresh) to DarkMind's web
...
# on DarkMind. APP_PORT is intentionally not used: it is only the Docker host
