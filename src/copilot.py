...
COPILOT_USER_AGENT = os.environ.get(
    "DARKMIND_COPILOT_USER_AGENT", "DarkMind/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "DARKMIND_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "DARKMIND_COPILOT_EDITOR_VERSION", "DarkMind/1.0"
)
