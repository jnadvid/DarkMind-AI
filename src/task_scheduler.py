...
class TaskScheduler:
    ...
    async def _deliver_via_email(self, output: str, task, result: str):
        ...
        try:
            ...
            msg["X-DarkMind-Origin"] = "darkmind-ui"
            msg["X-DarkMind-Kind"] = "task"
            msg["X-DarkMind-Ref"] = str(task.id)
    ...
    async def _deliver_via_mcp(self, tool_name: str, task, result: str):
        ...
        args = {
            ...
            "body": result,
            "headers": {
                "X-DarkMind-Origin": "darkmind-ui",
                "X-DarkMind-Kind": "task",
                "X-DarkMind-Ref": str(task.id),
            },
        }
        if recipient:
